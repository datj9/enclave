...
- **`X-Forwarded-For` is trusted up to `TRUSTED_PROXY_HOPS`.** Every supported deployment puts a
  ...
  documented in [docs/self-hosting.md](docs/self-hosting.md), not a defect to report.
